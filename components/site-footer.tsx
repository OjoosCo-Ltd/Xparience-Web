...
const SOCIALS = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/xparience/",
    icon: <LinkedInIcon className="size-4.5" />,
  },
  {
    label: "Facebook",
    href: "https://www.facebook.com/share/1FnpreNszY/?mibextid=wwXIfr",
    icon: <FacebookIcon className="size-4.5" />,
  },
  {
    label: "Threads",
    href: "https://www.threads.com/@ojoosco?igshid=NTc4MTIwNjQ2YQ==",
    icon: <AtSign className="size-5" />,
  },
];

export function SiteFooter() {
  const { status, handleSubmit } = useLeadForm("footer-newsletter");

  return (
    <footer className="bg-[#1c3947] pb-10 pt-16 sm:pt-20">
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-12">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-white/70">
              Stay connected to thoughtful conversations, product updates, and
              insights on meaningful relationships.
            </p>
          </div>
          <div>
        ...
        <div className="mt-16 grid gap-12 sm:mt-20 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-8 max-w-sm text-base leading-relaxed text-white/70">
              Dating and Lifestyle Platform Powered by Purpose not Swipes.
              Building the future of human connection, one shared experience at
              a time.
            </p>
          </div>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20">
          ...
          <div className="mt-8 flex flex-col gap-3 text-sm text-white/60 sm:flex-row sm:items-center sm:justify-between">
            <p>© 2026 Xparience. All Rights Reserved.</p>
            <p>
              Xparience is a trading name of OjoosCo Ltd, registered with the
              Information Commissioner&rsquo;s Office under UK GDPR.
            </p>
          </div>
        </div>
      </div>
